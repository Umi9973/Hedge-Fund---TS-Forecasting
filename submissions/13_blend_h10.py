"""
Step 13: Blend LightGBM + Autoencoder NN for h=10
- Retrain h=10 LightGBM (3-seed ensemble) with Optuna params
- Load NN val predictions; recover NN test predictions from saved blend file (alpha=1.00 → pure NN)
...
HORIZON_PARAMS = {
    ...
    'bagging_fraction': 0.859, 'early_stopping': 145,
}
...
nn_val_file  = AE_DIR / f"val_preds_h{H}_nn_cv0.1932.csv"
...
# Test preds — alpha=1.00 means blend IS pure NN
nn_test_df   = pd.read_csv(AE_DIR / f"test_preds_h{H}_blend_a1.00_cv0.1932.csv")
