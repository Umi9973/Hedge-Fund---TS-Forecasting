...
using standard LightGBM GBDT with Optuna-tuned params for h=25.

Baselines:
  LightGBM GBDT (344 features): val=0.2928 (Fold4), WF mean=0.2478
  CatBoost (344 features):      val=0.2535
"""
