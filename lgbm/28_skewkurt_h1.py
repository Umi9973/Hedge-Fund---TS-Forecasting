...
using standard LightGBM GBDT with Optuna-tuned params for h=1.

Baselines:
  LightGBM GBDT (344 features): val=0.0508
  CatBoost (344 features):      val=0.0508
"""
...
LGBM_PARAMS = {
    ...
    'metric':           'rmse',
    'n_estimators':     3000,
    'learning_rate':    0.04407,
    'max_depth':        9,
    'num_leaves':       20,
    'feature_fraction': 0.622,
    'bagging_fraction': 0.309,
    'bagging_freq':     5,
    'lambda_l1':        0.5,
    'lambda_l2':        1.058,
    'min_data_in_leaf': 59,
...
print(f"  Baseline LGBM    : 0.0508  ({score_avg - 0.0508:+.4f})")
